...
<head>
    ...
    <title>La Maison des Chansons</title>
...
<body>
    <div class="col-md-8 col-md-offset-2">
        <h2 class="text-center">La Maison Des Chansons</h2>
        <br />
        <div class="panel panel-default">
            <div class="panel-heading">
                <ul>
                    <li><i class="fa fa-file-text-o"></i> All the current Posts</li>
                    <a href="#" class="add-modal"><li>Ajouté un nouvelle Artiste</li></a>
                </ul>
            </div>
            ...
            <div class="panel-body">
                    <table class="table table-striped table-bordered table-hover" id="postTable" style="visibility: hidden;">
                        <thead>
                            <tr>
                                <th valign="middle">#</th>
                                <th>Artiste Et Album</th>
                                <th>Descriptif du style Musical</th>
                                <th>Published?</th>
